...
import { Dostv, PageProps, PaginateResponse } from '@/types'
...
export default function DostvIndex( {auth}: PageProps ) {
    ...
    const loadAsync = async () => {
		...
		try{
			const res = await axios.get<PaginateResponse>(`/admin/pages/get-dostvs?${params}`);
    ...
    const handClickNew = () => {
        router.visit('/admin/pages/dostvs/create');
    }
    const handleEditClick = (id:number) => {
        router.visit('/admin/pages/dostvs/' + id + '/edit');
    }
    


    const handleDeleteClick = async (id:number) => {
		const res = await axios.delete('/admin/pages/dostvs/' + id);
        ...
        <AdminLayout user={ auth.user } >
            ...
            <div className='flex mt-10 justify-center items-center'>
                ...
                <div className='p-6 w-full overflow-auto mx-2 bg-white shadow-sm rounded-md
                    ...
                    sm:w-[740px]'>
                    {/* card header */}
					<div className="font-bold mb-4 text-lg">LIST OF DOSTv VIDEOS</div>
