...
export default function FeaturedVideosCreateEdit( 
    ...
    const submit = async (values: object) => {
        ...
        if (id > 0) {
            try {
                const res = await axios.patch("/admin/pages/featured-videos/" + id, values);
                if (res.data.status === "updated") {
                    modal.info({
                        title: "Updated!",
                        content: <div>Featured video successfully updated.</div>,
                        onOk() {
                            router.visit("/admin/pages/featured-videos");
                        },
                    });
                }
            } catch (err: any) {
            ...
            try {
                const res = await axios.post("/admin/pages/featured-videos", values);
        ...
        <AdminLayout user={ auth.user } >
            ...
            <div className='flex mt-10 justify-center items-center'>
                ...
                <div className='p-6 w-full overflow-auto mx-2 bg-white shadow-sm rounded-md
                    ...
                    sm:w-[740px]'>
                    {/* card header */}
					<div className="font-bold mb-4 text-lg">ADD/EDIT FEATURED VIDEOS</div>
