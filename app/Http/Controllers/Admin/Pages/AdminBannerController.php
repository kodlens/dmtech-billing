...
class AdminBannerController extends Controller
{
    public function index(){
        return Inertia::render('Admin/Pages/Banner/BannerIndex');
    }
    ...
    public function create(){ 
        return Inertia::render('Admin/Pages/Banner/BannerCreateEdit',[
            'id' => 0,
            'banner' => null
        ]);
    }
    ...
    public function destory($id){
        ...
        if(Storage::exists('public/temp/' .$data->img)) {
            Storage::delete('public/temp/' . $data->img);
            return response()->json([
                'status' => 'temp_deleted'
            ], 200);
        }
